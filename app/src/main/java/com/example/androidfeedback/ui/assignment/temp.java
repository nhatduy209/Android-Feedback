...
public class ResultFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View root = inflater.inflate(R.layout.fragment_result, null  );
...
//        spinnerModule = (Spinner)root.findViewById(R.id.spinnerModule);
        ...
        ArrayList<ClassStatisticViewModel> list = new ArrayList<ClassStatisticViewModel>();
        list.add(new ClassStatisticViewModel(1,"class 1"));
        list.add(new ClassStatisticViewModel(2,"class 2"));
        list.add(new ClassStatisticViewModel(5,"class 3"));

        setSpinner(spinnerClass,listClass);

        return root;
    }
    private void setSpinner( Spinner spinner, List<ClassStatisticViewModel> listData){
